...
class BrandLikeCommandControllerTest {
	...
	class CreateBrandLikeTest {
		...
		void createSuccess() throws Exception {
			...
			given(brandLikeCommandFacade.createLike(anyString(), anyString(), eq(100L))).willReturn(outDto);
		...
		void createTargetNotFound() throws Exception {
			// Arrange
			given(brandLikeCommandFacade.createLike(anyString(), anyString(), eq(999L)))
	...
	class DeleteBrandLikeTest {
		...
		void deleteSuccess() throws Exception {
			// Arrange
			willDoNothing().given(brandLikeCommandFacade).deleteLike(anyString(), anyString(), eq(100L));
		...
		void deleteNotFound() throws Exception {
			...
			willThrow(new CoreException(ErrorType.LIKE_NOT_FOUND))
				.given(brandLikeCommandFacade).deleteLike(anyString(), anyString(), eq(100L));
