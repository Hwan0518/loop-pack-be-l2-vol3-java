package com.loopers.ordering.order.infrastructure.acl.user;
...
/**
 * ACL (Anti-Corruption Layer) - 주문 BC -> 사용자 BC 통합 구현체 (사용자 인증)
 * 주문 요청 시 사용자 인증을 수행하는 역할 (Provider Facade에 위임)
 */
@Component("orderUserAuthenticator")
