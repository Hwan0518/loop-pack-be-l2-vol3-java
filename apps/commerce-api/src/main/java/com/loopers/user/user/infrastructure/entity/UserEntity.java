...
import com.loopers.user.user.infrastructure.entity.vo.UserBirthdateEmbeddable;
import com.loopers.user.user.infrastructure.entity.vo.UserEmailEmbeddable;
import com.loopers.user.user.infrastructure.entity.vo.UserLoginIdEmbeddable;
import com.loopers.user.user.infrastructure.entity.vo.UserNameEmbeddable;
import com.loopers.user.user.infrastructure.entity.vo.UserPasswordEmbeddable;
