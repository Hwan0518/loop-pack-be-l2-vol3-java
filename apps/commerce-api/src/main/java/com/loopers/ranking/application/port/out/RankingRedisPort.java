...
public interface RankingRedisPort {
	 ...
	 * @deprecated daily_score 기반 carry-over 로 전환 예정. batchZadd 사용 권장.
	 */
	@Deprecated
	...
	/**
	 * 6. 배치 ZADD (carry-over 또는 rebuild 용)
	 * - 기존 member 가 있으면 점수 합산 (NX 아님)
	 * @param dateStr yyyyMMdd 키
	 * @param scores productId → score
	 */
	void batchZadd(String dateStr, java.util.Map<Long, Double> scores);
